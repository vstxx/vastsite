...
const notices = {
  ...
  privacy: {
    ...
    intro: 'Effective 28 August 2026. Vast is local-first and collects no browsing telemetry. This notice separates the Browser, Relay, Extensions Hub, website, and independently published extensions.',
    sections: [
      ...
      ['User controls and requests', 'Local browser data can be reviewed, exported, cleared or removed through Vast settings and profile controls. Removing Vast application state and reinstalling may create a new Relay installation UUID. For privacy or administrative requests concerning service-side data, start from the official Support or Legal pages and do not post installation identifiers or other personal information in public issue threads.'],
